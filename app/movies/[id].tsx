        ...
        paddingBottom:80}}>
          ...
          justify-center mt-5 px-5'>
            ...
            <View className='flex-row item-center gap-x-1 mt-2'>
              ...
              text-sm'>{movie?.release_date?.split('-')[0]}</Text>
              <Text className='text-light-200 
              text-sm'>{movie?.runtime}m</Text>
            </View>
            ...
            <MovieInfo label="Genres" value={movie?.genres?.map((genre) => genre.name).join('-') || 'N/A'} />
              ...
              <MovieInfo label='Production Comapnies' value={movie?.production_companies?.map((company) => company.name).join('-') || 'N/A'} />
